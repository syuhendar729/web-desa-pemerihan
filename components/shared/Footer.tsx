        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-10 mb-10">
          ...
          <div className="max-w-sm">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="font-bold text-xl tracking-wide">Desa Pemerihan</h3>
                <p className="text-amber-200 text-xs uppercase tracking-wider">Kabupaten Pesisir Barat</p>
              </div>
            </div>
          ...
          <div>
            <h4 className="font-semibold text-amber-200 mb-4 text-sm uppercase tracking-wider">Menu</h4>
            <ul className="space-y-3 text-sm text-amber-50">
              ...
              <li><a href="/tentang" className="hover:text-white hover:translate-x-1 transition-all inline-block">Tentang</a></li>
              <li><a href="/umkm" className="hover:text-white hover:translate-x-1 transition-all inline-block">Produk UMKM</a></li>
              <li><a href="/berita" className="hover:text-white hover:translate-x-1 transition-all inline-block">Informasi Publik</a></li>
            </ul>
          </div>
